...
final class SwiftDataNewsRepository: NewsRepository {
    ...
    private static func toUsage(_ job: NewsJob) -> NewsJobUsage? {
        ...
        return NewsJobUsage(
            ...
            cacheHitTokens: job.usageCacheHitTokens,
            cacheWriteTokens: job.usageCacheWriteTokens,
            cacheStorage5mTokens: job.usageCacheStorage5mTokens,
            cacheStorage1hTokens: job.usageCacheStorage1hTokens,
