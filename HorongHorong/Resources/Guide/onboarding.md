...
| `settings.memoShortcut` | 설정 · 메모의 **퀵 메모 단축키** |
| `companion.menu.schedule` | 루미롱 우클릭 메뉴의 **오늘 일정 보기** |
...
| `stats.showPeriod` | 상세 창에서 기간 통계 화면으로 전환 |
...
## 시나리오 1. 타이머로 집중하고 싶어요
<!-- id: focus-basic -->

*바로 집중하는 방법부터 등록해둔 할 일을 이어서 진행하는 방법까지 설명합니다.*
...
<!-- highlight: settings.memoShortcut -->
> 급할 땐 **단축키**로 어디서든 퀵 메모를 띄울 수 있어요. 설정의 메모 탭에서 단축키를 확인하고 바꿀 수 있어요.
...
### 2) 아무 때나 다시 본다
<!-- highlight: companion.menu.schedule -->
